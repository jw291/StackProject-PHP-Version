...
$sql = 'select * from comment_advertisement where co_no=co_order and b_no=' . $bno;
...
<form action="comment_update.php" method="post">
	...
	<div class="commentContent"><?php echo $row['co_content']?></div>
			...
			<?php
				$sql2 = 'select * from comment_advertisement where co_no!=co_order and co_order=' . $row['co_no'];
