...
if(!empty($bno) && empty($_COOKIE['board_thread_'.$bno])){
$sql = 'update board_thread set b_hit=b_hit +1 where b_no = '.$bno;
...
setcookie('board_thread_'.$bno,TRUE,time()+(60*60*40),'/');
 }
}
$sql = "select threadname, b_title, b_content, b_date, b_hit, b_id from board_thread where threadname = '$_SESSION[jointhreadname]' AND b_no= ".$bno;
...
?>
	<div class="btnSet">
		...
		<a href="../mythread.php?threadname=<?php echo $_SESSION['jointhreadname'] ?>">목록</a>
