...
$sql = "select * from comment_thread where co_no=co_order and threadname = '$_SESSION[jointhreadname]' and b_no=" . $bno;
...
<form action= "comment_update.php" method="POST" >
		...
		<input type='hidden' name='jointhreadname' value= <?php echo $_SESSION['jointhreadname'] ?>>
...
<form action="comment_update.php" method="post">
	...
	<div class="commentContent"><?php echo $row['co_content']?></div>
			...
			<?php
				$sql2 = "select * from comment_thread where co_no!=co_order and threadname = '$_SESSION[jointhreadname]' and co_order=" . $row['co_no'];
